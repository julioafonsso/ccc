...
//		builder.replace( index, index +9,matricula.getTurma().getModalidade().getNome());
...
//		builder.replace( index, index +9,matricula.getAluno().getNome());
		
		index = builder.indexOf("{{codTurma}}");
//		builder.replace( index, index +12,matricula.getTurma().getCodigo());
...
//						+ mensalidade.getMesReferencia().getMes() + "/" + mensalidade.getMesReferencia().getAno());
		...
		int index = builder.indexOf("{{turma}}");
//		builder.replace( index, index +9,mensalidade.getMatricula().getTurma().getModalidade().getNome());
...
//		builder.replace( index, index +17, mensalidade.getMesReferencia().getMes() + "/" + mensalidade.getMesReferencia().getAno());
		...
		index = builder.indexOf("{{valor}}");
//		builder.replace( index, index +9,new DecimalFormat("#.##").format(mensalidade.getFluxoCaixa().getValor()));
		
		index = builder.indexOf("{{aluno}}");
//		builder.replace( index, index +9,mensalidade.getMatricula().getAluno().getNome());
		
		index = builder.indexOf("{{codTurma}}");
//		builder.replace( index, index +12,mensalidade.getMatricula().getTurma().getCodigo());
